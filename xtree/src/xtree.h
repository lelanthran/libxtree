 ...
 *
 * The general form is:
 * Each stores either an atom or a list of atoms, in addition to a pointer to
 * a parent node and an ordered list (array) of children nodes. While this
 * general structure can represent everything, for convenience each node also
 * stores a name and a set of KV attributes (both plain text).
 *
...
// Set the first attribute with the specified name to the specified value.
